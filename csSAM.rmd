...
#install.packages("hexbin")
 # library(hexbin)
```{r}
         qplot(pureLiverExpr, deconvLiverExpr, aes(x = pureLiverExpr),geom = "hex", main="liver")
```
...
##        Density Plot of Deconvolved VS Pure Tissue (Brain)
        ========================================================
```{r}
        qplot(pureBrainExpr, deconvBrainExpr, aes(x = pureBrain,geom = "hex", main="brain")
```
...
##        Density Plot of Deconvolved VS Pure Tissue (Lung)
        ========================================================
```{r}
        qplot(pureLungExpr, deconvLungExpr, aes(x = pureLungExpr),geom = "hex", main="Lung")  
```
...
- csSAM has been updated to include added functionality to allow for switching between log-transformed and anti-log-transformed gene expression values when performing either the deconvolution or comparative expression steps 
